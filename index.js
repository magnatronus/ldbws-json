...
class OpenLDBSVWS {
  ...
  constructor(accessToken = "0000-0000-0000-0000", baseURL = "https://lite.realtime.nationalrail.co.uk/OpenLDBSVWS/ldbsv12.asmx") {
      this.accessToken = accessToken;
      this.baseURL = baseURL;
  }
...
module.exports.OpenLDBSVWS = OpenLDBSVWS;